...
<html lang="en">
  ...
  <body style="background-color:#f8f8ff;">
   ...
   <nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item active">
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="cad_pd.php"> Cadastrar mais um Produto <span class="sr-only"></span></a>
                </li>
                <li class="nav-item active">
        ...
        <h1 class ="bg-success text-center text-white">O Cadastro Foi um Sucesso!</h1>
  <section class ="container">
        <ul>
          <li>
              <form action="index.php" method="POST" class="col-form-label">
                  <p> O Clicar no botão abaixo, você irá voltar para o menu principal</p>
      ...
      <br>
        ...
        <p><a href = "cad_pd.php" class ="btn btn-info" role ="button"> Cadastrar mais um Produtos</a></p>    
      </div>
  </section>
